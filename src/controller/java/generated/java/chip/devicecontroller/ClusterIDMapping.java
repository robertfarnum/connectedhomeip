...
public class ClusterIDMapping {
    ...
    public static class JointFabricDatastore implements BaseCluster {
        ...
        public enum Command {
            ...
            public static Command value(long id) throws NoSuchFieldError {
                ...
                }public enum AddAdminCommandField {AdminInformationEntry(0),;
                    private final int id;
                ...
                }public enum AddBindingToEndpointForNodeCommandField {NodeID(0),EndpointID(1),;
                    private final int id;
                ...
                }public enum AddACLToNodeCommandField {NodeID(0),;
                    private final int id;
    ...
    public static class JointFabricPki implements BaseCluster {
        ...
        public enum Command {
            ICACSRRequest(0L),
            AddICAC(2L),
            TransferAnchorRequest(4L),
            TransferAnchorComplete(6L),;
            private final long id;
            Command(long id) {
                this.id = id;
            }
        ...
        }public enum AddICACCommandField {StatusCode(0),NOCIssuerCert(1),NodeId(2),FabricId(3),AdminVendorId(4),CaseAdminSubject(5),;
                    private final int id;
