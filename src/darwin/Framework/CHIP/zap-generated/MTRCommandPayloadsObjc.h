...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRJointFabricPkiClusterICACSRRequestParams : NSObject <NSCopying>
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRJointFabricPkiClusterICACSRResponseParams : NSObject <NSCopying>

@property (nonatomic, copy) NSData * _Nonnull nocIssuerCSR MTR_PROVISIONALLY_AVAILABLE;

/**
 * Initialize an MTRJointFabricPkiClusterICACSRResponseParams with a response-value dictionary
 * of the sort that MTRDeviceResponseHandler would receive.
 *
 * Will return nil and hand out an error if the response-value dictionary is not
 * a command data response or is not the right command response.
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRJointFabricPkiClusterAddICACParams : NSObject <NSCopying>
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRJointFabricPkiClusterAddICACResponseParams : NSObject <NSCopying>
...
/**
 * Initialize an MTRJointFabricPkiClusterAddICACResponseParams with a response-value dictionary
 * of the sort that MTRDeviceResponseHandler would receive.
 *
 * Will return nil and hand out an error if the response-value dictionary is not
 * a command data response or is not the right command response.
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRJointFabricPkiClusterTransferAnchorRequestParams : NSObject <NSCopying>
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRJointFabricPkiClusterTransferAnchorResponseParams : NSObject <NSCopying>

@property (nonatomic, copy) NSNumber * _Nonnull statusCode MTR_PROVISIONALLY_AVAILABLE;

/**
 * Initialize an MTRJointFabricPkiClusterTransferAnchorResponseParams with a response-value dictionary
 * of the sort that MTRDeviceResponseHandler would receive.
 *
 * Will return nil and hand out an error if the response-value dictionary is not
 * a command data response or is not the right command response.
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRJointFabricPkiClusterTransferAnchorCompleteParams : NSObject <NSCopying>
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
