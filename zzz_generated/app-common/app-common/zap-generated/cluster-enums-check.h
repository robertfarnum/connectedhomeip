...
static auto __attribute__((unused)) EnsureKnownEnumValue(JointFabricPki::ICACSigningRequestStatusEnum val)
{
    using EnumType = JointFabricPki::ICACSigningRequestStatusEnum;
    switch (val)
    {
    case EnumType::kOk:
    case EnumType::kInvalidIcaCsrFormat:
    case EnumType::kInvalidIcaCsrSignature:
    case EnumType::kFailedDclVendorIdValidation:
    case EnumType::kNotAnIcac:
    case EnumType::kBusyAnchorTransfer:
    case EnumType::kIcaCsrSigningFailed:
    case EnumType::kIcaCsrRequestNoUserConsent:
        return val;
    default:
        return EnumType::kUnknownEnumValue;
    }
}
static auto __attribute__((unused)) EnsureKnownEnumValue(JointFabricPki::TransferAnchorResponseStatusEnum val)
{
    using EnumType = JointFabricPki::TransferAnchorResponseStatusEnum;
    switch (val)
    {
    case EnumType::kOk:
