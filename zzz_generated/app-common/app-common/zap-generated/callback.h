...
/**
 * @brief Joint Fabric Pki Cluster ICACSRRequest Command callback (from client)
 */
...
/**
 * @brief Joint Fabric Pki Cluster AddICAC Command callback (from client)
 */
...
/**
 * @brief Joint Fabric Pki Cluster TransferAnchorRequest Command callback (from client)
 */
bool emberAfJointFabricPkiClusterTransferAnchorRequestCallback(
    chip::app::CommandHandler * commandObj, const chip::app::ConcreteCommandPath & commandPath,
    const chip::app::Clusters::JointFabricPki::Commands::TransferAnchorRequest::DecodableType & commandData);
/**
 * @brief Joint Fabric Pki Cluster TransferAnchorComplete Command callback (from client)
 */
bool emberAfJointFabricPkiClusterTransferAnchorCompleteCallback(
    chip::app::CommandHandler * commandObj, const chip::app::ConcreteCommandPath & commandPath,
    const chip::app::Clusters::JointFabricPki::Commands::TransferAnchorComplete::DecodableType & commandData);
/**
