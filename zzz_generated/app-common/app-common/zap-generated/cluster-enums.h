...
// Enum for ICACSigningRequestStatusEnum
enum class ICACSigningRequestStatusEnum : uint8_t
{
    kOk                          = 0x00,
    kInvalidIcaCsrFormat         = 0x01,
    kInvalidIcaCsrSignature      = 0x02,
    kFailedDclVendorIdValidation = 0x03,
    kNotAnIcac                   = 0x04,
    kBusyAnchorTransfer          = 0x05,
    kIcaCsrSigningFailed         = 0x06,
    kIcaCsrRequestNoUserConsent  = 0x07,
    // All received enum values that are not listed above will be mapped
    // to kUnknownEnumValue. This is a helper enum value that should only
    // be used by code to process how it handles receiving and unknown
    // enum value. This specific should never be transmitted.
