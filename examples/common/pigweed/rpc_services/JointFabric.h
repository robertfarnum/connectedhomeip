...
class JointFabricServiceImpl : public pw_rpc::nanopb::JointFabric::Service<JointFabricServiceImpl> {
    public:
        pw::Status OpenCommissioningWindow(const joint_fabric_TextMessage& request, joint_fabric_ErrorCode& response);
};

class JointFabricControlServiceImpl : public pw_rpc::nanopb::JointFabricControl::Service<JointFabricControlServiceImpl> {
    public:
        pw::Status OpenCommissioningWindow(const joint_fabric_TextMessage& request, joint_fabric_ErrorCode& response);
        pw::Status CommissionDevice(const joint_fabric_TextMessage& request, joint_fabric_ErrorCode& response);
};
